  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 shadow-xl p-8 space-y-4">
      <div className="flex items-center gap-2 text-blue-600">
        <Sparkles size={18} />
        <h4 className="text-[10px] font-black uppercase tracking-widest">Magic Fill AI</h4>
      </div>
      ...
      <button 
        ...
        disabled={loading}
        className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-100 disabled:opacity-50"
      >
