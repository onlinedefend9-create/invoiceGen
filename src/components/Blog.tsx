...
---
*Guide written by the InvoiceGEN team.*
` });

  return (
    <article className="max-w-4xl mx-auto space-y-16 pt-32 pb-24 px-6">
      <header className="text-center space-y-4">
        ...
        <h1 className="text-5xl font-black tracking-tighter leading-tight">{t('blog.heroTitle', { defaultValue: "The Complete Guide to Invoicing for SMEs and Freelancers in 2026" })}</h1>
      </header>

      <section className="bg-white rounded-[48px] border border-slate-100 shadow-2xl p-16 space-y-12 relative overflow-hidden">
